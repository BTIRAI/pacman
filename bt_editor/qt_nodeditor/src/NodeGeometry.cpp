...
//  totalHeight += step / 2.0;
  ...
  double x = _width / 2.0;// + nodeStyle.ConnectionPointDiameter;
  ...
  switch (portType)
  {
    case PortType::Out:
    {
      ...
      result = QPointF(x, height() + nodeStyle.ConnectionPointDiameter);
      break;
    }
    ...
    case PortType::In:
    {
      ...
      result = QPointF(x, -nodeStyle.ConnectionPointDiameter);
      break;
    }
